...
*/
		...
		public static final List<Integer> screenRocks = new ArrayList<Integer>(){
			{
				this.add(SCREENROCK_6);
			}
		};

		public static final List<Integer> videoTypes = new ArrayList<Integer>() {
	        {
	            this.add(VIDEO_2);
	            this.add(SCREENROCK_6);
	    ...
	    public static final List<Integer> resTypes = new ArrayList<Integer>() {
	        {
	...
	public static final List<Integer> powtoonResTypes = new ArrayList<Integer>() {
		{
			this.add(RES_FILE_LINK);
			this.add(RES_FILE);
			this.add(VIDEO_2);
