...
//    @NotNull(message="videoId不可为空")
    ...
    @IntTypeConstraint(values = {TableConstant.gcUserVideoAction_type_like1,TableConstant.gcUserVideoAction_type_rate2}, message = "type必须是1，2")
    @NotNull(message="type类型不可为空")
    @ApiModelProperty(value = "1:点赞2:评价3:星级评价")
