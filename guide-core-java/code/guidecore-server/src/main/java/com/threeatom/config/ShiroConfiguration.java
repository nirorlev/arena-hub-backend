...
//		filterChainDefinitionMap.put("/api/*/guidecore/getIp", "anon");
		...
		filterChainDefinitionMap.put("/api/v1/guidecore/homeInfo/html/hub","anon"); // James - trying to get SSR working
		filterChainDefinitionMap.put("/api/v1/guidecore/homeInfo/html/hub/**","anon"); // James - trying to get SSR working, I don't think we need the next line if this works
