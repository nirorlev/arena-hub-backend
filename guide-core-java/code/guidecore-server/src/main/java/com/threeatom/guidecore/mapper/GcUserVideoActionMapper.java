...
public interface GcUserVideoActionMapper extends BaseMapper<GcUserVideoAction> {
    ...
    List<Map<String, Object>> countTypeRateForVideo(
            @Param("videoId") Integer videoId, @Param("type") Integer type);
    ...
    @MapKey("subjectId")
    Map<Integer, GcUserVideoAction> getSubjectUserStars(
            @Param("subId") Integer subId, @Param("videoList") List<Integer> videoList);
    ...
    List<GcUserVideoAction> getReviewListByCourseId(
            @Param("subId") Integer subId,
            @Param("starType") Integer starType,
            @Param("starFilter") Integer starFilter,
            @Param("starOrder") Integer starOrder);
}
