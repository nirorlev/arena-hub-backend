...
//1. 表：sys_file
    ...
    public static final String sysFile_folder_guidecoreVedioCaption = "guidecore/vedio/caption";//字幕文件
	...
	public static final String sysFile_folder_linkVideoScreenrock="link/video/screenrock";//视频类链接-screenrock
	...
	public static final List<String> sysFile_video_folder_list = new ArrayList<String>() {
        {
	...
	public static final List<String> sysFile_res_folder_list = new ArrayList<String>() {
        {
            this.add(sysFile_folder_guidecoreRes);
            this.add(sysFile_folder_linkRes);
        }
    };
	public static final List<String> sysFile_folder_link_list = new ArrayList<String>() {
        {
	...
	public static final List<String> sysFile_fileType_list = new ArrayList<String>() {
        {
...
//2. 表：gc_master_home_info 门户首页信息
    ...
    public static final String gcMasterHomeInfo_name_playListPageShareTitle = "playListPageShareTitle";
    ...
    public static final List<String> gcMasterHomeInfo_name_page = new ArrayList<String>(){
        {
	...
	public static final List<String> gcMasterHomeInfo_name_homepage_list = new ArrayList<String>() {
        {
...
//    public static final String gcMasterHomeInfo_name_homepage_list_names = gcMasterHomeInfo_name_homepage_list.stream().map(s -> "\'" + s + "\'").collect(Collectors.joining(", "));
    public static final List<String> gcMasterHomeInfo_name_welcomeVideo_list = new ArrayList<String>() {
        {
    ...
    public static final List<String> gcMasterHomeInfo_name_welcomeVideo_stuList = new ArrayList<String>() {
        {
            this.add(gcMasterHomeInfo_name_studentWelcomeVideo);
            this.add(gcMasterHomeInfo_name_studentIntroVideo);
        }
    };
    public static final List<String> gcMasterHomeInfo_name_welcomeVideo_mentList = new ArrayList<String>() {
        {
            this.add(gcMasterHomeInfo_name_mentorWelcomeVideo);
            this.add(gcMasterHomeInfo_name_mentorIntroVideo);
        }
    ...
    public static final List<String> gcSubjectIntroInfo_name_Introduction_page_list = new ArrayList<String>() {
        {
...
//    public static final String gcMasterHomeInfo_name_welcomeVideo_list_names = gcMasterHomeInfo_name_welcomeVideo_list.stream().map(s -> "\'" + s + "\'").collect(Collectors.joining(", "));
	//type字段
