...
public interface NewUiGcSubjectService {
	 ...
	 * @return
	 */
	PageInfo<GcSubject> list(Map<String, Object> params, SysSystem system, HttpServletRequest request,Integer envFlag);
	 ...
	 * @return
	 */
	PageInfo<GcSubject> listSubjectByFid(Map<String, Object> params, SysSystem sys, HttpServletRequest request,boolean ifLogin,List<Integer> subIds,Integer envFlag);
	...
	List<GcSubject> buildSubject2(List<GcSubject> subjects,Integer userId,SysSystem system,HttpServletRequest request,Integer code);
