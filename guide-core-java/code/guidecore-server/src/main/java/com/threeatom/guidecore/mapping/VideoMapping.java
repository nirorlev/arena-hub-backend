...
public abstract class VideoMapping {
    ...
    @Mapping(target = "owner.firstName", source = "originChannel.createUser.info.firstName")
    @Mapping(target = "owner.lastName", source = "originChannel.createUser.info.lastName")
    @Mapping(target = "owner.thumbUrl", source = "originChannel.createUser.info.avatarFile.fileUrl")
    ...
    @Mapping(target = "owner.firstName", source = "originCourse.userInfo.info.firstName")
    @Mapping(target = "owner.lastName", source = "originCourse.userInfo.info.lastName")
    @Mapping(target = "owner.thumbUrl", source = "originCourse.userInfo.info.avatarFile.fileUrl")
    @Mapping(target = "created", source = "createTime")
    @Mapping(target = "updated", source = "updateTime")
    ...
    @Mapping(target = "deprecatedVideoFileId", source = "video.videoFile.id")
