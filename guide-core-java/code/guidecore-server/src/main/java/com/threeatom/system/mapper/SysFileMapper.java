...
public interface SysFileMapper extends BaseMapper<SysFile> {
    ...
    List<SysFile> selectFilesByTypeIndexAndTagSearch(
            ...
            @Param("typeIndexIds") List<Integer> typeIndexIds,
            @Param("searchString") String searchString,
            @Param("fileId") Integer fileId,
            @Param("uploadUid") Integer uploadUid);

    Map<String, Object> selectFileTagJSONStrByFolder(
            @Param("masterId") Integer masterId,
            @Param("sysId") Integer sysId,
            @Param("folders") List<String> folders);

    Integer selectCountNotBelongMaster(
    ...
    List<SysFile> getHistoryUpload(
            @Param("masterId") Integer masterId,
            @Param("userId") Integer userId,
            @Param("folder") String folder);

    List<SysFile> getSysFileByIdsOrVideos(
