...
public interface GcMasterMessageService extends IService<GcMasterMessage> {
    ...
    List<Map<String, Object>> getUnReadMessageByUserIds(
    ...
    List<GcMasterMessage> getLastMessageByStudentIds(
    ...
    List<Map<String, Object>> getAllEventUnMessageDetail(
            Integer masterId, Integer userId, Integer targetUserId);

    List<Map<String, Object>> getAllSubUnMessageDetail(
            Integer masterId, Integer userId, Integer targetUserId);

    // 设置video问题回答已读
    boolean setAnswerIsRead(
    ...
    // 老师获取学生问题答案的未读消息
    List<Map<String, Object>> getEventAnswerUnReadList(
