 ...
 */
@Service
public class GcUserVideoPlaysNodeServiceImpl extends ServiceImpl<GcUserVideoPlaysNodeMapper, GcUserVideoPlaysNode> implements GcUserVideoPlaysNodeService {
    ...
    public List<GcUserVideoPlaysNode> getVideoPlayNodesByVideoId(Integer vid,Integer userId,Integer masterId) {
