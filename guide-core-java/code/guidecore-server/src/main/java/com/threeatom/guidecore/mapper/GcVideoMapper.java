...
public interface GcVideoMapper extends BaseMapper<GcVideo> {
	...
	List<GcVideo> getVideoIdListByPermissionId(@Param("accessPermissionId") List<Integer> accessPermissionId);

	List<GcVideo> getVideoListByUserIdsAndSubjectId(@Param("userIdList")List<Integer> userIdList,@Param("subjectId")Integer subjectId,@Param("masterId")Integer masterId);
	 ...
	 * @return
	 */
	List<GcVideo> selectVideosBySubIdsAndVideoName(@Param("subIds") List<Integer> subIds,@Param("videoName")  String videoName);
	 ...
	 * @return
	 */
    Long sumVideoLongByIdUser(@Param("videoIds") List<Integer> videoIds, @Param("userId")  Integer userId);
	 ...
	 * @return
	 */
    Long sumPlayVideoLongByIdUser(@Param("videoIds") List<Integer> videoIds, @Param("userId")  Integer userId);
	...
	//正常只返回一个
	List<GcVideo> selectVideoByVideoAndSub0NameIndex(String videoNameIndex,String subNameIndex,Integer masterId);

	List<GcVideo> selectVideoAndTimeByIds(@Param("list") List<Integer> idList,@Param("masterId")Integer masterId);
	...
	Integer countVideoNumInPortal(@Param("masterId")Integer masterId,@Param("type")Integer type,@Param("state")Integer state,@Param("subIds") List<Integer> subIds,@Param("managerId")Integer managerId);

	List<GcVideo> getSysFileByIdsOrVideos(@Param("fileList")List<Integer> fileList,@Param("videoList")List<Integer> videoList);

	List<Integer> getIdsBySubIds(@Param("subIds")List<Integer> subIds);

	List<GcVideo> selectVideoPlayListBySubId(@Param("subId")Integer subId,@Param("userId")Integer userId);
