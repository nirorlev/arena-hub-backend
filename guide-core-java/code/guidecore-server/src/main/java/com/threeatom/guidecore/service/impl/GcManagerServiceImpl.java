...
public class GcManagerServiceImpl extends ServiceImpl<GcManagerMapper, GcManager> implements GcManagerService {
	...
	@Override
	@Transactional
	public boolean createManager(Integer sysId, String email, String password, String fName, String lName, String code) {
		boolean flag;
		try {
		// TODO Auto-generated method stub
	...
	public String loginGetToken(String email, String password) {
		...
		if(manager==null) throw new SystemException(I18NUtil.get("guidecore.master.login.usernameError"));
