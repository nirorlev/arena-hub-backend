...
@Service
public class PtChannelContentServiceImpl extends ServiceImpl<PtchannelContentMapper, PtChannelContent> implements PtChannelContentService {
    ...
    public List<SysFile> selectVideosInChannel(Integer channelId, String order, Integer fileId, HttpServletRequest request){
