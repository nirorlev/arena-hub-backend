...
public class GuideCoreUserRealm extends AuthorizingRealm {
    ...
    @Autowired @Lazy private GcManagerService managerService;

    @Autowired @Lazy private GcUserService userService;
    ...
    private SimpleAuthenticationInfo doWebClient(String tokenStr) {
        ...
        switch (role) {
            case "manager":
                ...
                if (manager == null) throw new AuthenticationException("没有找到账户");
            ...
            case "user":
                ...
                if (user == null) throw new AuthenticationException("没有找到账户");
