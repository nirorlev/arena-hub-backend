 ...
 */
@Service
public class GcUserSaveContentFollowServiceImpl extends ServiceImpl<GcUserSaveContentFollowMapper, GcUserSaveContentFollow> implements GcUserSaveContentFollowService {

    private static final Logger LOGGER = LoggerFactory.getLogger(GcUserSaveContentFollowServiceImpl.class);

    @Resource
    GcUserSaveContentFollowMapper gcUserSaveContentFollowMapper;
