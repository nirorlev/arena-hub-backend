...
public interface GcSubjectMapper extends BaseMapper<GcSubject> {
    ...
    List<GcSubject> selectAllSubList(
            @Param("masterId") Integer masterId, @Param("stateAndType") Integer stateAndType);
    ...
    List<GcSubject> gvgSelectAllLevel1SubList(
            @Param("subIds") List<Integer> subIds,
            @Param("order") String order,
            @Param("masterId") Integer masterId);

    List<GcSubject> selectSubjectVideoList(
            @Param("subIds") List<Integer> subIds,
            @Param("order") String order,
            @Param("masterId") Integer masterId,
    ...
    List<GcSubject> selectSubjectByIdList(
    ...
    GcSubject getSubjectByNameIndex(
            @Param("portalId") String portalId, @Param("nameIndex") String nameIndex);
    ...
    List<GcSubject> selectOrgMustJsonArrayList(
