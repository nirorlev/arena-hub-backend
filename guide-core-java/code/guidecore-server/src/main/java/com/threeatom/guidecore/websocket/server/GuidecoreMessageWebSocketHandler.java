...
public class GuidecoreMessageWebSocketHandler extends TextWebSocketHandler{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(GuidecoreMessageWebSocketHandler.class);

	private static int onlineCount=0;
	
	private static ConcurrentHashMap<Integer, WebSocketSession> webSocketMap=new ConcurrentHashMap<Integer, WebSocketSession>();
