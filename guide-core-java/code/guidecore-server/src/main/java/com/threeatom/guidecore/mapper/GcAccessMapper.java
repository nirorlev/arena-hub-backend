...
public interface GcAccessMapper extends BaseMapper<GcAccess> {
    ...
    List<GcAccess> getAllPackage(
            Integer masterId, Integer showFlag, List<Integer> packageIdList, List<Integer> idList);
    ...
    List<GcAccess> listContentGroups(@Param("masterId") Integer masterId, @Param("userId") Integer userId);
